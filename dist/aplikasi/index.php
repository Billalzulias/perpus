                    ...
                    <div class="col-xl-4 col-lg-5">
                        ...
                        <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Profile Aplikasi</h6>
                            </div>
                            <?php 
                            ...
                            <div class="card-body">
                                <form action="aplikasi/edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Nama Ketua Pimpinan Perpustakaan:</label>
                        ...
                        <!-- Card Header - Dropdown -->
                            ...
                            <div class="card-body">
                                <form action="aplikasi/edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Estimasi waktu Peminjaman Buku: <span id="info_waktu_pinjam"><?php if (isset( $data['waktu_peminjaman'])) echo $data['waktu_peminjaman'];?> hari</span> </label>
                                    ...
                                    <div class="form-group">
                                        <label>Maksimal Peminjaman Buku: <span id="info_maksimal_pinjam"><?php if (isset( $data['maksimal_peminjaman'])) echo $data['maksimal_peminjaman'];?> Pustaka</span> </label>
                                    ...
                                    <div class="form-group">
                                        <label>Harga Denda Keterlambatan Peminjaman: <span id="info_denda_terlambat">Rp. <?php if (isset( $data['denda_keterlambatan'])) echo number_format($data['denda_keterlambatan'],0,',','.'); ?>/hari</span> </label>
